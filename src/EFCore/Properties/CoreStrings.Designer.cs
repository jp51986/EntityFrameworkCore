...
namespace Microsoft.EntityFrameworkCore.Internal
{
    ...
    public static class CoreStrings
    {
        ...
        /// <summary>
        ///     The query type '{entityType}' cannot be added to the model because an entity type with the same name already exists.
        /// </summary>
        public static string CannotAccessEntityAsQuery([CanBeNull] object entityType)
            => string.Format(
                GetString("CannotAccessEntityAsQuery", nameof(entityType)),
                entityType);
        ...
        /// <summary>
        ///     The query type '{entityType}' cannot be added to the model because a query type with the same name already exists.
        /// </summary>
        public static string DuplicateQueryType([CanBeNull] object entityType)
            => string.Format(
                GetString("DuplicateQueryType", nameof(entityType)),
                entityType);
